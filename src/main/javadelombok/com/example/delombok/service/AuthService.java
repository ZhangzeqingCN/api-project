...
package com.example.delombok.service;
...
public class AuthService {
    ...
    public Result register(@NotNull RegisterRequestBody registerRequestBody) {
        ...
        userRepository.save(User.builder().name(registerRequestBody.getUsername()).password(registerRequestBody.getPassword1()).gender(registerRequestBody.getGender()).build());
        return Result.success();
    }
