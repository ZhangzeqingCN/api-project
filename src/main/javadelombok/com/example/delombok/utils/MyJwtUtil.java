...
package com.example.delombok.utils;
...
public class MyJwtUtil {
    ...
    private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(MyJwtUtil.class);
    ...
    public String createToken(String username, int seconds) {
        ...
        return JWT.create().withSubject("authentication").withIssuer("issuer").withClaim(identityKey, username).withIssuedAt(currentTime).withExpiresAt(expirationTime).sign(algorithm);
    }
}
